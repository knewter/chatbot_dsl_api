# Idea taken from http://www.dantswain.com/blog/2015/04/19/integration-testing-a-json-api-in-phoenix/
defmodule ChatbotDslApi.Support.APICall do
  use HTTPoison.Base
  ...
  defp api_url do
    endpoint_config = Application.get_env(:chatbot_dsl_api, ChatbotDslApi.Endpoint)
